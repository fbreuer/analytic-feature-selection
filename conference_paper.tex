...
The results of this experiment are shown in Figure~\ref{fig:AllProps}. Each plot shows the \textcolor{blue}{standardized z-scores of the} values of a particular geometric property for each of the 717 feature sets in our training data. The value of this ratio is plotted against a \textcolor{blue}{standardized} measure of that particular feature set's performance. In most cases this measure is classifier accuracy, but in the case of $f_4$, we noticed a much stronger correlation between the $f_4$ value and the $F_1$-Score for a given feature set, which is defined as
